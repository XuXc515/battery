...
public class AliPayUtil {
     ...
     */
    private static final String HTTPS_VERIFY_URL = "https://openapi.alipaydev.com/gateway.do";
    ...
    public static String getNotifyUrl(HttpServletRequest request) {
        ...
        return requestURL.substring(0, requestURL.indexOf("/aliPay/")) + AliPayConfig.NOTIFY_URL;
    }
